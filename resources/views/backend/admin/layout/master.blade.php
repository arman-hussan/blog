	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{{route('admin.index')}}"><span>Metro</span></a>
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="{{route('admin.index')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>	
							<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Catagory</span><span class="label label-important"> New </span></a>
							<ul>
								<li><a class="submenu" href="{{route('admin.catagory.create')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Catagory</span></a></li>
								<li><a class="submenu" href="{{route('admin.catagories')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Catagory</span></a></li>
							</ul>	
						</li>
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="{{route('admin.products')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Products</span></a></li>
							</ul>	
						</li>
